...
public class Const {
    ...
    public static final String POSITION_TOP = "kTUBannerAdShowingPositionTop";
    public static final String POSITION_BOTTOM = "kTUBannerAdShowingPositionBottom";
    ...
    public static final String IMAGE_PTUH = "imagePath";
    ...
    public static class RewardedVideo {
        public static final String USER_ID = "kTUAdLoadingExtraUserIDKey";
        public static final String USER_DTUA = "kTUAdLoadingExtraUserDataKeywordKey";
    }

    public static class Interstitial {
        public static final String UseRewardedVideoAsInterstitialKey = "UseRewardedVideoAsInterstitialKey";
        public static final String SHOW_CUSTOM_EXT = "kTUAdShowCustomExtKey";
    }
    ...
    public static String[] initMethodNames = {"setLogEnabled", "setChannelStr", "setSubchannelStr", "setCustomDataDic",
            ...
            "showGDPRAuth", "initThinkUpSDK", "deniedUploadDeviceInfo","setPresetPlacementConfigPath","showGDPRConsentDialog", "showDebuggerUI"};
