...
class SSContetti extends StatefulWidget {
  @override
  _SSContettiState createState() => _SSContettiState();
}

class _SSContettiState extends State<SSContetti> {
