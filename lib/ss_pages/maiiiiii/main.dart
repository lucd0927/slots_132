...
class _MainState extends State<Main> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: mainView(),
      // body: Center(
      //   // child: SingleColumnInfiniteScroll(items: List.generate(
      //   //   5,
      //   //       (i) => Container(
      //   //     height: 40,
      //   //     alignment: Alignment.center,
      //   //     color: i.isEven ? Colors.teal : Colors.orange,
      //   //     child: Text('Item $i', style: const TextStyle(color: Colors.white)),
      //   //   ),
      //   // ),),
      //
      //   // child: SlotMachineeee(),
      //   child: SSSlotMachine(),
      //
      //   // child: Marquee(
      ...
      //   //         SizedBox(width: 8),
      //   //         Text("限时活动火热进行中！", style: TextStyle(fontSize: 18)),
      //   //         SizedBox(width: 8),
