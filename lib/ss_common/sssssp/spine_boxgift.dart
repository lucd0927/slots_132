...
class SSSpineBoxgift extends StatefulWidget {
  const SSSpineBoxgift({super.key});

  @override
  State<SSSpineBoxgift> createState() => _SSSpineBoxgiftState();
}

class _SSSpineBoxgiftState extends State<SSSpineBoxgift> {
  bool showA = false;
  ...
  Widget build(BuildContext context) {
    ...
    return SpineWidget.fromAsset(
      Assets.donghua.sdjl.a2Atlas,
      Assets.donghua.sdjl.skeleton,
      controller,
    );
  }
}
