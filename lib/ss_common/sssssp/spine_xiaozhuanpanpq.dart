...
class SSSpineXiaozhuanpanpq extends StatefulWidget {
  const SSSpineXiaozhuanpanpq({super.key});

  @override
  State<SSSpineXiaozhuanpanpq> createState() => _SSSpineXiaozhuanpanpqState();
}

class _SSSpineXiaozhuanpanpqState extends State<SSSpineXiaozhuanpanpq> {
  bool showA = false;
  ...
  Widget build(BuildContext context) {
    ...
    return SpineWidget.fromAsset(
      Assets.donghua.xiaozhuanpanbj.xiaozhuanpanbjAtlas,
      Assets.donghua.xiaozhuanpanbj.skeleton,
      controller,
    );
  }
}
