...
class SSSpineJackpotMajor extends StatefulWidget {
  const SSSpineJackpotMajor({super.key});

  @override
  State<SSSpineJackpotMajor> createState() => _SSSpineJackpotMajorState();
}

class _SSSpineJackpotMajorState extends State<SSSpineJackpotMajor> {
  bool showA = false;
