...
class SpineFreespinSelected extends StatefulWidget {
  const SpineFreespinSelected({super.key});

  @override
  State<SpineFreespinSelected> createState() => _SpineFreespinSelectedState();
}

class _SpineFreespinSelectedState extends State<SpineFreespinSelected> {
  bool showA = false;
  ...
  Widget build(BuildContext context) {
    ...
    return SpineWidget.fromAsset(
      Assets.donghua.freespinS.sjqAtlas,
      Assets.donghua.freespinS.skeleton,
      controller,
      sizedByBounds: true,
    );
  }
