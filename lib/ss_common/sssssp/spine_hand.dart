...
class SpineHand extends StatefulWidget {
  const SpineHand({super.key});

  @override
  State<SpineHand> createState() => _SpineHandState();
}

class _SpineHandState extends State<SpineHand> {
  bool showA = false;
  ...
  Widget build(BuildContext context) {
    ...
    return SpineWidget.fromAsset(
      Assets.donghua.hand.handAtlas,
      Assets.donghua.hand.skeleton,
      controller,
      sizedByBounds: true,
    );
  }
