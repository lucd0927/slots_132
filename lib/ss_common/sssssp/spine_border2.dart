...
class SSSpineBorder2 extends StatefulWidget {
  const SSSpineBorder2({super.key});

  @override
  State<SSSpineBorder2> createState() => _SSSpineBorder2State();
}

class _SSSpineBorder2State extends State<SSSpineBorder2> {
  bool showA = false;
  ...
  Widget build(BuildContext context) {
    var data = MainController.composition(EnumLottieType.bian2);
    if(data != null){
