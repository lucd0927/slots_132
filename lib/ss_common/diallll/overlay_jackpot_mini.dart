...
class JackpotMiniWidget extends StatefulWidget {
  const JackpotMiniWidget({
    super.key,
    required this.onBtn,
    required this.money,
  ...
  @override
  State<JackpotMiniWidget> createState() => _JackpotMiniWidgetState();
}

class _JackpotMiniWidgetState extends State<JackpotMiniWidget> {
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            SSAScale(
                              child: Image.asset(
                                Assets.img.popupJackpotMini.path,
                                width: 267.h,
                                height: 91.h,
                              ),
                            ),
