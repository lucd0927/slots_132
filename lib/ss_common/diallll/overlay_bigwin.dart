...
class BigwinWidget extends StatefulWidget {
  const BigwinWidget({super.key, required this.onBtn, required this.money});

  final double money;
  final ValueChanged<double> onBtn;

  @override
  State<BigwinWidget> createState() => _BigwinWidgetState();
}
