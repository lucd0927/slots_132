...
class JackpotMajorWidget extends StatefulWidget {
  const JackpotMajorWidget({
    super.key,
    required this.onBtn,
    required this.money,
  ...
  @override
  State<JackpotMajorWidget> createState() => _JackpotMajorWidgetState();
}

class _JackpotMajorWidgetState extends State<JackpotMajorWidget> {
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            SSAScale(
                              child: Image.asset(
                                Assets.img.popupJackpotMajor.path,
                                width: 267.h,
                                height: 91.h,
                              ),
                            ),
