...
class SSAnimatedWinSuper extends StatefulWidget {
  const SSAnimatedWinSuper({
    super.key,
  ...
  @override
  State<SSAnimatedWinSuper> createState() => _SSAnimatedWinSuperState();
}

class _SSAnimatedWinSuperState extends State<SSAnimatedWinSuper>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      // ssLogggg("======topS:$topS");
        ...
        //             angle: -0.7,
        //             topLeft: false,
        //             child: Image.asset(Assets.mya.bigwin.win.path),
        //           ),
        //         ),
        //       ),
        //     ),
                ...
                child: Center(
                  child: FittedBox(
                    child: ShiningEffect(
                      ...
                      angle: -0.7,
                      topLeft: false,
                      child: Image.asset(Assets.mya.superwin.win.path),
                    ),
                  ),
                ),
              ),
