...
class SSAnimatedWinBig extends StatefulWidget {
  const SSAnimatedWinBig({
    super.key,
  ...
  @override
  State<SSAnimatedWinBig> createState() => _SSAnimatedWinBigState();
}

class _SSAnimatedWinBigState extends State<SSAnimatedWinBig>
