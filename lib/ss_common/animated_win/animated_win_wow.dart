...
class SSAnimatedWinWow extends StatefulWidget {
  const SSAnimatedWinWow({
    super.key,
  ...
  @override
  State<SSAnimatedWinWow> createState() => _SSAnimatedWinWowState();
}

class _SSAnimatedWinWowState extends State<SSAnimatedWinWow>
              ...
              child: Center(
                child: FittedBox(
                  child: ShiningEffect(
                    ...
                    child: Image.asset(Assets.mya.wow.wow.path),
                  ),
                ),
              ),
            ),
