...
class SSAnimatedJackpotMajor extends StatefulWidget {
  const SSAnimatedJackpotMajor({
    super.key,
  ...
  @override
  State<SSAnimatedJackpotMajor> createState() => _SSAnimatedJackpotMajorState();
}

class _SSAnimatedJackpotMajorState extends State<SSAnimatedJackpotMajor>
                  ...
                  child: Center(
                    child: FittedBox(
                      child: ShiningEffect(
                        ...
                        angle: -0.9,
                        topLeft: false,
                        child: Image.asset(Assets.mya.jackpot.majorH.path),
                  ...
                  child: Center(
                    child: FittedBox(
                      child: ShiningEffect(
                        ...
                        angle: -0.9,
                        topLeft: false,
                        child: Image.asset(Assets.mya.jackpot.major.path),
                        // child: Image.asset(Assets.mya.superwin.supers.path),
                      ),
                    ),
                  ),
                  ...
                  child: Center(
                    child: FittedBox(
                      child: ShiningEffect(
                        ...
                        angle: -0.7,
                        topLeft: false,
                        child: Image.asset(Assets.mya.jackpot.majorJ.path),
                      ),
                    ),
                  ),
                ),
